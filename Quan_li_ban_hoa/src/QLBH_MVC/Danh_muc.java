 ...
 * @author TOSHIBA
 */
public class Danh_Muc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setLayout(new java.awt.GridLayout(1, 4, 30, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Danh_Muc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
