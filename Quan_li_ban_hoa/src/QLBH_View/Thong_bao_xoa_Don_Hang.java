 ...
 * @author TOSHIBA
 */
public class Thong_bao_xoa_Don_Hang extends javax.swing.JFrame {

    /**
     * Creates new form Thong_bao_xoa
     */
    public Thong_bao_xoa_Don_Hang() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Thong_bao_xoa_Don_Hang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thong_bao_xoa_Don_Hang().setVisible(true);
            }
        });
    }
