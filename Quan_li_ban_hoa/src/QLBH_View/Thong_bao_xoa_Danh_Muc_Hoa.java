 ...
 * @author TOSHIBA
 */
public class Thong_bao_xoa_Danh_Muc_Hoa extends javax.swing.JFrame {

    /**
     * Creates new form Thong_bao_xoa
     */
    public Thong_bao_xoa_Danh_Muc_Hoa() {
        initComponents();
    }
    
    /**
     * Thêm ActionListener cho nút Đồng ý trên thông báo
     *
    ...
    /**
     * Thêm ActionListener cho nút Hủy trên thông báo
     *
     * @param all ActionListener xử lý sự kiện
     */
    ...
    /**
     * Thêm ActionListener cho nút Thoát trên thông báo
     *
     * @param all ActionListener xử lý sự kiện
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Bạn chắc chắn muốn xóa!! Thông tin không thể khôi phục");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Thong_bao_xoa_Danh_Muc_Hoa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Thong_bao_xoa_Danh_Muc_Hoa().setVisible(true);
            }
        });
    }
